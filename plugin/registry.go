...
Welcome to Wash, a UNIX-like shell that lets you manage all your things (entries) as
if they were files and directories. This entry (thing) represents the Wash root.
`
